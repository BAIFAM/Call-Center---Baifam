...
import { IContact, IContactStatus } from "@/app/types/api.types";
...
export function ContactDetailsInfo({ contact, onMarkAsVerified }: ContactDetailsInfoProps) {
      ...
      <div className="flex items-end justify-between h-full w-full gap-6 ">
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-900">
                Product: {localContact.product.name}
              </span>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div className="flex flex-col h-full items-center justify-end">
          <div className="flex items-end justify-center gap-3  ">
            ...
            <Button onClick={handleMarkAsVerified} disabled={markingAsVerified || localContact.status === "verified"} className="bg-primary-700  rounded-xl ">
              {markingAsVerified ? (
              ...
              <span>
                {markingAsVerified ? "Verifying..." : "Mark as Verified"}
              </span>
        ...
        <div className="text-left h-full border-l-2 pl-3 border-gray-200">
          ...
          <p className="text-sm text-gray-500 mb-1">
            May 12, 2025 - Now • 23 Calls Handled
          </p>
        </div>
      </div>
    </div>
